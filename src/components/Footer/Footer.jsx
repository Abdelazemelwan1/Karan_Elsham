...
export default function Footer() {
  return <>
    ...
    <div className="flex items-center justify-between container max-w-[90%]   sm:max-w-[36rem] md:max-w-[45rem] lg:max-w-[62rem]  xl:max-w-[74rem]  2xl:max-w-[88rem]  mx-auto mt-[30px]">
